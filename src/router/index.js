...
import Category from '/src/views/BusinessCategory.vue'
...
const routes = [
    ...
    { path: '/featured-members', name: 'Members', component: Members },
    ...
    { path: '/reviews', name: 'Bookings', component: Bookings, meta: { requiresAuth: true } },
