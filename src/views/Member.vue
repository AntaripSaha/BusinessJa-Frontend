...
export default {
  ...
  methods: {
    ...mapActions('eService', ['resetPagination', 'incrementPage', 'getSearchFeaturedServicesAction']),
    loadEServices() {
      this.getSearchFeaturedServicesAction({ keywords: this.$route.params.keywords })
    },
    loadMoreEService() {
      this.incrementPage()
      this.loadEServices()
